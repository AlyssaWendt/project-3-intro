# ![](https://ga-dash.s3.amazonaws.com/production/assets/logo-9f88ae6c9c3871690e33280fcf557f33.png) Project 3: React Frontend 

Let's kick it up a notch and build a modular and modern front end application using React!

Like with project two, the Unit 3 project is a chance to build a project that you can share with future prospective employers to demonstrate your skills and evolution as a software engineer. 
...
You may work in a group is you wish, but the technical requirements will match the extra dev hours you will spend with the project. A list of requirements can be found [here](./project-group-requirements.md). 

For this project, you **must** submit your idea to your section lead in the form of a [project proposal](#pre-project-deliverable-required) by the date specified in your cohort's calendar.
...
1. It must include data from a third-party API.
...
Therefore, each student will be given 4 (four) tokens to ask for help. Each token will give you 20 minutes of one-on-one consultation time with an instructor. 
...
An instructor or IA will be assigned to each engineer will check in with you briefly every day (whether via Slack or on Zoom). The purpose of these check-ins is NOT to discuss technical questions, but to answer questions about workflow and get a status check-in.
